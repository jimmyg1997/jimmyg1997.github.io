...
<div class="instagram-feed">
  <div class="instagram-grid">
    ...
    <div class="instagram-post">
      ...
      <div class="instagram-likes">
        <strong>89 likes</strong>
      </div>
      <div class="instagram-caption">
        <strong>dimisthenics</strong> Exploring new places and staying active! 🏃‍♂️ Travel and fitness go hand in hand. #travel #fitness #adventure
      </div>
      <div class="instagram-time">5 HOURS AGO</div>
    </div>
    ...
    <div class="instagram-post">
      ...
      <div class="instagram-image">
        <img src="/assets/images/volunteering-header.jpg" alt="Volunteering work" />
      </div>
      <div class="instagram-actions">
        <div class="instagram-icons">
          <span class="like-icon">♡</span>
      ...
      <div class="instagram-likes">
        <strong>156 likes</strong>
      </div>
      <div class="instagram-caption">
        <strong>dimisthenics</strong> Giving back to the community! 🤝 Volunteering and making a positive impact. #volunteering #community #impact
      </div>
